...
class MechanicDetailsWidget extends StatefulWidget {
  MechanicDetailsWidget({
    Key key,
    this.court,
  }) : super(key: key);
  ...
  @override
  _MechanicDetailsWidgetState createState() => _MechanicDetailsWidgetState();
}

class _MechanicDetailsWidgetState extends State<MechanicDetailsWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CommentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CommentsRecord> mechanicDetailsCommentsRecordList = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
                                          ...
                                          child: Text(
                                            valueOrDefault<String>(
                                              functions.getAverageRating(
                                                  mechanicDetailsCommentsRecordList
                                                      .toList()),
                                              '-',
                                            ),
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Builder(
                            builder: (context) {
                              final comments =
                                  mechanicDetailsCommentsRecordList?.toList() ??
                                      [];
                              if (comments.isEmpty) {
                                return Image.asset(
                                  'assets/images/lgon.png',
                                );
                              }
                              return Container(

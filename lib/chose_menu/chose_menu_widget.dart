...
class ChoseMenuWidget extends StatefulWidget {
  ChoseMenuWidget({Key key}) : super(key: key);

  @override
  _ChoseMenuWidgetState createState() => _ChoseMenuWidgetState();
}

class _ChoseMenuWidgetState extends State<ChoseMenuWidget> {

...
class RateMechanicPageWidget extends StatefulWidget {
  RateMechanicPageWidget({
    Key key,
    this.court,
  }) : super(key: key);
  ...
  @override
  _RateMechanicPageWidgetState createState() => _RateMechanicPageWidgetState();
}

class _RateMechanicPageWidgetState extends State<RateMechanicPageWidget> {
